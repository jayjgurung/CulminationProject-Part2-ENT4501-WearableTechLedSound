...
static float BAND_GATE[5]      = { 0.010f, 0.012f, 0.014f, 0.016f, 0.030f };
...
static const float edgesHz[6] = { 100, 300, 1100, 3200, 6000, 8000 };
...
static void renderBands(const float bands[5]) {
  for (int i=0;i<NUM_LEDS;i++){
    ...
    uint8_t bri = (v > 0.06f) ? (uint8_t)(v * 255) : 0;
    leds[i] = bandColor(i);
