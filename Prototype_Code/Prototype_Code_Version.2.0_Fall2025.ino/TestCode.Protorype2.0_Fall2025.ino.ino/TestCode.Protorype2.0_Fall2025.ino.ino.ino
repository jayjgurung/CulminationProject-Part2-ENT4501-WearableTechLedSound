...
#define LED_DATA_PIN   5       // WS2812 data pin
#define IR_RECV_PIN    15      // IR receiver output pin
#define I2S_WS_PIN     25      // LRCLK / WS
#define I2S_SCK_PIN    26      // BCLK / SCK
#define I2S_SD_PIN     27      // DOUT from mic -> ESP32
...
const uint8_t IR_KEY_1_FALLBACK = 0x45;  // change to your remote’s code if needed
